    ...
    <main className="">
      ...
      <div className=" max-w-5xl mx-auto ">
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-5 mt-10 md:mt-24 mb-12">
          ...
          <div className="card-container w-[96%] md:w-1/2 max-w-[480px] min-h-[350px] flex flex-col justify-between bg-slate-200  px-3 sm:px-7 pt-7 pb-4">
            <div className="">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-stretch justify-center md:justify-between gap-3 lg:gap-5 px-2 my-16 ">
          <div className=" bg-slate-100 w-full max-w-md md:max-w-[330px] pt-4 pb-4 pl-4 md:p-6">
