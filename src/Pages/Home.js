...
const Home = () => {
  ...
  return (
    <main className="">
      ...
      <Heading head="service we " headtwo={"provide"} /></div>
      <div className=" grid gap-y-20 sm:px-4 lg:px-2">
        <div  className=" max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-x-4 lg:gap-x-32">
          <div data-aos="fade-right" data-aos-offset="400" className=" w-[90%] md:w-1/2 max-w-[550px]">
            <img src={posimage} alt="pos service illustration" />
          </div>
          <div data-aos="fade-left" data-aos-offset="300" className=" w-[96%] md:w-1/2 card-container  max-w-[480px] shadow-[0_10px_25px_rgba(0,0,0,0.1)] rounded-xl ">
            <ServiceBox
              head="POS service"
        ...
        <div className=" max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center justify-between gap-x-4 lg:gap-x-10 ">
          <div data-aos="fade-left" data-aos-offset="400" className="w-[90%] md:w-1/2 max-w-[550px] ">
            <img
          ...
          <div data-aos="fade-right" data-aos-offset="300"  className="w-[96%] md:w-1/2 card-container max-w-[480px] shadow-[0_10px_25px_rgba(0,0,0,0.1)] rounded-xl">
            <ServiceBox
              head="ERP service"
        ...
        <div className=" max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-x-4 lg:gap-x-32">
          <div data-aos="fade-right" data-aos-offset="500" className="w-[90%] md:w-1/2 max-w-[550px]">
