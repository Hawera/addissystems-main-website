    ...
    <footer className=" bg-black [#454262] black pt-12 pb-8 text-white">
      <div className="container max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-y-7 gap-x-1 px-6">
        <ul className="">
          ...
          <li className=" font-light text-base pr-20 hover:text-addispink duration-300 ">
            <a href="#home">
        ...
        <ul className="">
          ...
          <li className="font-light text-base hover:text-addispink duration-300">
        ...
        <ul className="">
          ...
          <li className=" flex items-center font-light text-base  hover:text-addispink duration-300">
